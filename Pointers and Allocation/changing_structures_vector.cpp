...
// Recebe um aluno passado por referência, e preenche o campo 'media' com a média das 3 notas do aluno.
...
// Recebe vetor de alunos ('turma') e número de alunos ('n'), e chama a função 'calcula_media' (da questão anterior) para cada aluno do vetor.
